...
class AnswerController extends Controller
{
    ...
    public function update(Request $request, $question, $answer)
    {
        ...
        $answer->save();
        return redirect()->route('answers.show',['question_id' => $question, 'answer_id' => $answer])->with('message', 'Updated Answer');
    }
    /**
    ...
    public function destroy($question, $answer)
    {
        $answer = Answer::find($answer);
        $answer->delete();
        return redirect()->route('questions.show',['question_id' => $question])->with('message', 'Deleted Answer');
    }
}